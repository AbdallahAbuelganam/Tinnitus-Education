          ...
          <div className="bg-gradient-to-br from-teal-50 to-blue-50 p-6 rounded-lg">
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-white p-4 rounded-lg">
                <h3 className="text-gray-900 mb-2">Myth 1:</h3>
                <p className="text-gray-600">
              ...
              <div className="bg-white p-4 rounded-lg">
                <h3 className="text-gray-900 mb-2">Fact 1:</h3>
                <p className="text-gray-600">
                  Tinnitus is a symptom, not a disease. It can
                  result from noise damage, neurological or
                  vascular conditions, brain injury, or certain
                  medications. There is no cure, but treatments
                  can reduce symptoms and improve quality of
                  life.
                </p>
              </div>

              <div className="bg-white p-4 rounded-lg">
                <h3 className="text-gray-900 mb-2">Myth 2:</h3>
                <p className="text-gray-600">
              ...
              <div className="bg-white p-4 rounded-lg">
                <h3 className="text-gray-900 mb-2">Fact 2:</h3>
                <p className="text-gray-600">
                  Hearing aids can help manage tinnitus by
                  correcting hearing loss and masking tinnitus
                  sounds. Modern hearing aids and sound therapy,
                  along with stress management and lifestyle
                  changes, can reduce tinnitus symptoms.
                </p>
              </div>

              <div className="bg-white p-4 rounded-lg">
                <h3 className="text-gray-900 mb-2">Myth 3:</h3>
                <p className="text-gray-600">
              ...
              <div className="bg-white p-4 rounded-lg">
                <h3 className="text-gray-900 mb-2">Fact 3:</h3>
                <p className="text-gray-600">
                  There is no cure, but tinnitus can be managed
                  using noise-masking machines, hearing aids,
                  and cognitive-behavioral therapy (CBT) to
                  reduce its perception.
                </p>
              </div>

              <div className="bg-white p-4 rounded-lg">
                <h3 className="text-gray-900 mb-2">Myth 4:</h3>
                <p className="text-gray-600">
              ...
              <div className="bg-white p-4 rounded-lg">
                <h3 className="text-gray-900 mb-2">Fact 4:</h3>
                <p className="text-gray-600">
                  Tinnitus is not always lifelong and may
                  resolve, especially when the underlying cause
                  such as infection or injury is treated.
                </p>
              </div>

              <div className="bg-white p-4 rounded-lg">
                <h3 className="text-gray-900 mb-2">Myth 5:</h3>
                <p className="text-gray-600">
                  Eating a Healthy Diet Will Cure Tinnitus
                </p>
              </div>

              <div className="bg-white p-4 rounded-lg">
                <h3 className="text-gray-900 mb-2">Fact 5:</h3>
                <p className="text-gray-600">
                  A healthy diet supports overall well-being but
                  does not cure tinnitus.
                </p>
              </div>

              <div className="bg-white p-4 rounded-lg">
                <h3 className="text-gray-900 mb-2">Myth 6:</h3>
                <p className="text-gray-600">
              ...
              <div className="bg-white p-4 rounded-lg">
                <h3 className="text-gray-900 mb-2">Fact 6:</h3>
                <p className="text-gray-600">
                  Although common with hearing loss, tinnitus
                  can also result from ear infections,
                  cardiovascular disease, or traumatic brain
                  injury.
                </p>
              </div>
            </div>
